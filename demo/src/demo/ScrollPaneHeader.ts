import { EventType, GComponent, type Controller } from 'fairygui-babylon';

export class ScrollPaneHeader extends GComponent {
    ...
    protected onConstruct(): void {
        ...
        this.on(EventType.SIZE_CHANGED, this.onSizeChanged, this);
    }
