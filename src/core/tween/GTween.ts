import type { GTweener } from './GTweener.js';
import { TweenManager } from './TweenManager.js';

/**
 * Entry point for creating tweens. Every tweener is owned by `TweenManager`,
 * which needs `TweenManager.update(dt)` to be driven from the host's frame loop.
 */
export class GTween {
